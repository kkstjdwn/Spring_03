...
<c:import url="../layout/bootStrap.jsp"/>
	<div class="container">
		<h2>ANSER WRITE</h2>
		<form class="form-horizontal" action="qnaReply" method="post" onsubmit=true>
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="title">답변 제목</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="contents" name="contents"> [질문내용]  ${vo.contents } [질문내용] </textarea>
				</div>
			</div>
		<!--**********************버튼그룹 -->
